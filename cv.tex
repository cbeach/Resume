...
\begin{itemize}[leftmargin=0in]
    \item[] 
        \textbf{Nike Dreams: Senior Application Engineer, Certified Scrum Master} \hfill \textbf{September 2014-Present} \\[-0.1in] \rule{\textwidth}{0.5pt}
        ...
        \begin{itemize}[leftmargin=0in]
            \item[] 
                \begin{samepage}
                    ...
                    \begin{itemize}
                        \item[\textbullet] Dream Walker is a Java application designed to replay data into the Dreams pipeline. It is used for
                ...
                \begin{samepage}
                    ...
                    \begin{itemize}
                        \item[\textbullet] We are using the ELK stack for search and visualization.
                    \end{itemize}
                \end{samepage}
                \begin{samepage}
                    \textbf{Spark} \hfill \textbf{September 2014-Present} \\
                    \begin{itemize}
                        \item[\textbullet] Spark streaming is used for data enrichment, active session tracking, stream connectors for Couchbase  
