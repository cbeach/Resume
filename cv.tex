...
\begin{itemize}[leftmargin=0in]
    \item[] \textbf{Artificial Inteligence, Machine Learning, and Computer Vision} \\[-0.1in] \rule{\textwidth}{0.5pt}
        \begin{itemize}[leftmargin=0in]
            \item[] 
                \begin{samepage}
                    \textbf{Deep Thought} \hfill \textbf{May 2012-Present} \\
                    This is an attempt to implement the Atari playing, deep learning AI from Deep Mind. Deep thought uses computer vision to isolate game artifacts and 
                    sprites from the NES. This should vastly reduce the size of the input layer; improving both the speed of learning, and the quality of the final neural net.
                    \begin{itemize}
                        \item[\textbullet] Determines the size of repeating tiles by using a one dimension fast fourier transform 
                    \end{itemize}
                \end{samepage}
            \item[] 
                \begin{samepage}
