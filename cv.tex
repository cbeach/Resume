    ...
    \item[] 
        ...
        \item[] 
            \begin{samepage}
                ...
                I designed the walled garden to give my team a stable baseline for my team's docker based infrastructure.
                \begin{itemize}
                    \item[\textbullet] Ansible IAC for baking and deploying ec2 images
                    \item[\textbullet] First team in Cambia to be using docker in production!
                    \item[\textbullet] Uses docker-compose to create services
                \end{itemize}
            \end{samepage}
            \vspace{0.125in}
        \item[] 
