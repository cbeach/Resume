    ...
    \item[] 
        ...
        \item[] 
            \begin{samepage}
                ...
                \begin{itemize}
                    \item[\textbullet] Currently refactoring old foundational libraries/modules to make use of new infrastructure features 
                    \item[\textbullet] Cuttently integrating into our service mest Envoy to make use of cutting edge service mesh technology
                    \item[\textbullet] Deprecated 73 very old and incompatible AWS instances and related infrastructure, 
                    \item[\textbullet] The instance alone save Cambia \$20,000 per month
