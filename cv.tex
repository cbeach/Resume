...
%    \item[]
%    \textbf{Job: Title} \hfill \textbf{Start Month-End Month} \\[-0.1in] \rule{\textwidth}{0.5pt}
%    %TODO: This needs more work
%    Description
%    \vspace{0.125in}
%    \item[]
%    \textbf{Team 1} \hfill \textbf{Start-End} \\
%    Team description
%    \begin{itemize}
%        \item[]
%        \textbf{Project 1} \hfill \textbf{Start-End} \\
%        Project description
%        \begin{itemize}
%            \item[\textbullet] Bulleted list of responsivility/deliverables
%            \item[\textbullet] another thing
%        \end{itemize}
%        \vspace{0.125in}
%    \end{itemize}
%    \vspace{0.125in}
%
%    \textbf{Team2} \hfill \textbf{Start-End} \\
%    Team description
%    \begin{itemize}
%        \item[]
%        \textbf{Project} \hfill \textbf{Start-End} \\
%        Project description
%        \begin{itemize}
%            \item[\textbullet] Bulleted list of responsivility/deliverables
%            \item[\textbullet]
