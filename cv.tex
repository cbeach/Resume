        ...
        \begin{itemize}[leftmargin=0in]
            \item[] 
                \begin{samepage}
                    ...
                    \begin{itemize}
                        \item[\textbullet] Allows replay and recovery from s3 buckets.
                        \item[\textbullet] Users can specify a date range, Dream Walker will retrieve the corresponding objects and stream the sequentially into Kafka
                    \end{itemize}
                \end{samepage}
                \begin{samepage}
                    ...
                    \begin{itemize}
                        \item[\textbullet] Authored a Kibana 4 sidecar which allows monitoring of kibana. 
                        \item[\textbullet] Deployed Kibana 4, allowing business users to visuallize near real time data.
