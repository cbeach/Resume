            ...
            \item[] 
                \begin{samepage}
                    ...
                    \begin{itemize}
                        ...
                        \item[\textbullet] My sorware determines the size of repeating tiles by using fast fourier transforms
                        \item[\textbullet] I extract sprites for player and non-player characters (PC, NPC respecitvely)
...
\begin{itemize}[leftmargin=0in]
    \item[] 
        ...
        scope and cross service type safety where fRPC/Protbuf was present in the codebase. I worked to resolve these issues by:
        \begin{itemize}
