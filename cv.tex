...
\begin{resume}
% META: begin.section.summare_of_qualifications
...
\section{EXPERIENCE}
\vspace{0.125in}
% META: end.section.summare_of_qualifications
...
\begin{itemize}[leftmargin=0in]
    % META: begin.section.experience.nike.dreams
    \item[] 
        ...
        \begin{itemize}[leftmargin=0in]
            \item[] 
                % META: begin.section.experience.nike.dreams.dreamwalker
                \begin{samepage}
                    ...
                    \end{itemize}
                \end{samepage}
                % META: end.section.experience.nike.dreams.dreamwalker
                % META: begin.section.experience.nike.dreams.elk
                \begin{samepage}
                    ...
                    \end{itemize}
                \end{samepage}
                % META: end.section.experience.nike.dreams.elk
        \end{itemize}
        % META: end.section.experience.nike.dreams
\end{itemize}
\vspace{0.25in}
% META: end.section.experience.nike


% META: begin.section.experience.parthenon
\begin{itemize}[leftmargin=0in]
    % META: begin.section.experience.parthenon.lead
    \item[] 
        ...
        \begin{itemize}[leftmargin=0in]
            \item[] 
                % META: begin.section.experience.parthenon.lead.feedback_innovations
                \begin{samepage}
                    ...
                    \end{itemize}
                \end{samepage}
                % META: end.section.experience.parthenon.lead.feedback_innovations
                % META: begin.section.experience.parthenon.lead.2nDealer
                \begin{samepage}
                    ...
                    \end{itemize}
                \end{samepage}
                % META: end.section.experience.parthenon.lead.2nDealer
        \end{itemize}
        \vspace{0.125in}
    % META: end.section.experience.parthenon.lead
    % META: begin.section.experience.parthenon.dev
    \item[] 
        \textbf{PARTHENON SOFTWARE: Software Developer} \hfill \textbf{April 2012-August 2014} \\[-0.1in] \rule{\textwidth}{0.5pt}
        \begin{itemize}[leftmargin=0in]
            % META: begin.section.experience.parthenon.dev.avaya_bridge
            \item[] 
                \begin{samepage}
                    ...
                    \end{itemize}
                \end{samepage}
            % META: end.section.experience.parthenon.dev.avaya_bridge
            % META: begin.section.experience.parthenon.dev.precision_dynamics
            \item[]
                \begin{samepage}
                    ...
                    \end{itemize}
                \end{samepage}
            % META: end.section.experience.parthenon.dev.precision_dynamics
        \end{itemize}
        % META: end.section.experience.parthenon.dev.precision_dynamics
\end{itemize}
\vspace{0.25in}
...
% META: begin.section.experience.personal_projects
\begin{itemize}[leftmargin=0in]
...
\end{itemize}
\vspace{0.25in}
% META: end.section.experience.personal_projects

% META: begin.section.experience.psu
\begin{itemize}[leftmargin=0in]
    \item[] \textbf{Portland State University} \\[-0.1in] \rule{\textwidth}{0.5pt}
        ...
        \end{itemize}
\end{itemize}
% META: end.section.experience.psu
	
% META: begin.section.experience.education
\section{EDUCATION} 
\begin{multicols}{2}
...
\end{multicols}
% META: end.section.experience.education
