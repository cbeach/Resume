...
=======
                    ...
                    sprites, and game rules from retro games. The ultimate goal is to create an unsupervized tool that automatically 
                    reverse engineer games.  The goal is to vastly reduce the size of the input layer that a naive implementation of 
                    DeepMind would require.  This will improve both the speed of learning, and the quality of the final neural network.
>>>>>>> Stashed changes
                    \begin{itemize}
