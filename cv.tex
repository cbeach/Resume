        ...
        \item[] 
            \begin{samepage}
                ...
                \begin{itemize}
                    ...
                    \item[\textbullet] Performed a cross validation of data on the two clusters at the behest of the VP. Validation included several key metrics, as well as a detailed validation of a statistically significant sample of the clusters.
            ...
            \begin{samepage}
                ...
                \begin{itemize}
                    ...
                    \item[\textbullet] Was personally responsible for converting several legacy rails endpoints to Go
                    %TODO: \item[\textbullet] More things here.
                \end{itemize}
            \end{samepage}
            \vspace{0.125in}
            ...
            \begin{samepage}
                ...
                When first adopted, Go was a new language to Gametime. As always with new tools, it took a while for the developers to gain 
                experience with the new language and become comfortable with the new language.  As such, the codebase developed very organic 
                while the general code architecture was devised. This organic growth lead to maintainability issues.
                \begin{itemize}
                    \item[\textbullet] Identified and devised solutions to maintainability issues.
                    \item[\textbullet] Issues included:
                    \begin{itemize}
                      \item[\textbullet] "type bloat" or many different versions of the same information being present in the same scope.
                      \item[\textbullet] Cross service type safety. gRPC/Protobuf was present in the codebase and is to mitigate this, but had fallen out of favor. I proposed automated refactoring tools. 
                      \item[\textbullet] 
                    \end{itemize}
                    \item[\textbullet] Devised and began work on a code analysis and refactoring tool inspired by Go Guru.
